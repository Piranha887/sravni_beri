...
# Создание класса YearCheck, наследующегося от класса BoundFilter
class YearCheck(BoundFilter):
    # Метод check для проверки типа года в сообщении
    async def check(self, message: types.Message):
        try:
            pattern = re.compile(r"^(19|20)\d{2}$")  # Задание шаблона для регулярного выражения
